...
for epoch in range(epochs):
    ...
    for index, batch in enumerate(train):
        ...
        edge_loss = net.batch_binary_cross_entropy_loss(e_6, edges)
        ...
        writer.add_image("node_edge", torch.cat((block_gt[0, 0:1], edge_region_predict[0, 0:1]), 2), step)
        writer.add_image("train_image", cat_in_out_gt(imgs[0], e_6[0], edges[0]), step)
    ...
    with torch.no_grad():
        ...
        for index, batch in enumerate(val):
            ...
            writer.add_image("val_image_step", cat_in_out_gt(imgs[0], e_6[0], edges[0]), val_step)
            writer.add_image("train_image", cat_in_out_gt(imgs[0], e_6[0], edges[0]), step)
        ...
        writer.add_image("val_image", cat_in_out_gt(imgs[0], e_6[0], edges[0]), val_step)
