...
from models import EdgeGroupingOnGCN
...
net: EdgeGroupingOnGCN = EdgeGroupingOnGCN().cuda(device)

optimizer = torch.optim.Adam([
    {'params': net.bottom.parameters()},
    {'params': net.surface.parameters()},
    {'params': net.backend.parameters()},
    {'params': net.num_predict.parameters()},
], lr=5e-4, betas=(0.9, 0.999), )


def forward(net: EdgeGroupingOnGCN, image, instance_masking, instance_edge, instance_num, edge, pool_edge,
